...
#splitdata_matrix[is.na(splitdata_matrix)] <- 0
#sum(is.na(splitdata_matrix))
...
#training_locations <- sample(floor(p*nrow(splitdata_matrix)))

train_data <- New_user_artists_matrix[training_locations,]
#train_data <- splitdata_matrix[training_locations,]

test_data <- New_user_artists_matrix[-training_locations,]
#test_data <- splitdata_matrix[-training_locations,]
